  ...
  useEffect(() => {
    const fetchchart = async () => {
      try {
        ...
        const chart_data = [
          { name: 'Completed', value: data.completed? 0 : 10, color: '#13ab3eff', legendFontColor: '#000', legendFontSize: 12 },
          { name: 'Rejected', value: data.rejected? 0 : 50, color: '#c40808ff', legendFontColor: '#000', legendFontSize: 12 },
          { name: 'assigned', value: data.assigned, color: '#445befff', legendFontColor: '#000', legendFontSize: 12 },
          { name: 'Submitted', value: data.submitted, color: '#f0e909ff', legendFontColor: '#000', legendFontSize: 12 },
          { name: 'Approved', value: data.approved, color: '#970c8eff', legendFontColor: '#000', legendFontSize: 12 },
          { name: 'Deleted', value: data.deleted, color: '#5d5b5bff', legendFontColor: '#000', legendFontSize: 12 },
        ];
